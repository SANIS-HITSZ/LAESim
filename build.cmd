...
if "%VisualStudioVersion%" == "" (
    echo(
    echo oh oh... You need to run this command from x64 Native Tools Command Prompt for VS 2019 or VS 2022.
    goto :buildfailed_nomsg
)
if "%VisualStudioVersion%" lss "16.0" (
    echo(
    echo Hello there! This AirSim copy expects Visual Studio 2019 or newer.
    echo Please use the x64 Native Tools Command Prompt for VS 2019 or VS 2022.
    goto :buildfailed_nomsg
)

set "CMAKE_GENERATOR=Visual Studio 16 2019"
if not "%VisualStudioVersion%" lss "17.0" (
...
IF EXIST Unreal\Assets\Boat\Models\Boat (
    ...
    IF NOT EXIST Unreal\Plugins\AirSim\Content\Models\Boat\Type_052B_Destroyer_Combined.uasset (
        ECHO Unable to find Boat model asset. BoatPawn will use the fallback mesh.
    )
)
